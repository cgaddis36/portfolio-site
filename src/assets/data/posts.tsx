...
const posts: Post[] = [
  {
    id: 1,
    date: "12/20/2024",
    title: "ShoreCasts Database Cleanup",
    body: [
      "If you're reading this, welcome to my first blog post. Today I will be sharing some of the recent development work I have been doing on a mobile app I created earlier this year, which is now available on both Android and iOS. ShoreCasts is designed to help anglers plan their day on the water.",
      "The past two weeks on the ShoreCasts engineering team, have been spent developing an admin dashboard to help our team analyze, create, update and remove database objects from our production environment. The main driving force behind building this application is the need to manage and groom our data that has been persistently growing, and expanding since beginning to develop this product at the start of this year.  The main data our team is focused on at this stage of the product is the Marinas, Boat Ramps, & Tackle Shops that we provide our Users access to. Earlier this year, after scraping Google for information on these entities based on specific use-case parameters, we filled our database with over 9,000 combined Marinas, Boat Ramps & Tackle Shops across every US coastal state.",
      "",
